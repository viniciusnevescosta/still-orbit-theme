...
| --- | --- |
| ![Still Orbit wallpaper](./preview/wallpaper.png) | ![Still Orbit site preview](./preview/site.png) |
...
Add the license that best matches how you want to distribute the theme.
